...
>>>>>>> e230d8da49c86f08e564a99938151111524d5ade
...
=======
                ('receipt_no', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, unique=True)),
                ('rating', models.IntegerField(default=0)),
                ('review', models.TextField(blank=True, max_length=255)),
                ('due_date', models.DateField(default='N/A')),
                ('return_date', models.DateField(default='N/A')),
...
>>>>>>> e230d8da49c86f08e564a99938151111524d5ade
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="books_ratings", to="readventure.receipt"
            ),
        ),
        migrations.AddField(
            model_name="books",
            ...
            field=models.ManyToManyField(
                related_name="books_receipt_numbers", to="readventure.receipt"
            ),
        ),
        migrations.AddField(
            model_name="books",
            name="reviews",
            field=models.ManyToManyField(
                related_name="books_reviews", to="readventure.receipt"
            ),
        ),
        migrations.AddField(
            model_name="user",
            name="booklist",
            field=models.ManyToManyField(
                related_name="user_books", to="readventure.books"
            ),
        ),
        migrations.AddField(
            model_name="user",
        ...
        migrations.AddField(
            ...
            name="wishlist",
            field=models.ManyToManyField(
                related_name="user_wishlist", to="readventure.books"
            ),
        ),
    ]
